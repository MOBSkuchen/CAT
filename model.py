...
from api.tokenization import SOS_ID
from api.tokenization import EOS_ID
import api.beam as beam
from api.layers import EmbeddingLayer
from api.layers import FeedForwardNetwork
from api.layers import Attention
...
class TransformerModel(tf.keras.layers.Layer):
  ...
  """
    ...
    """
        ...
        bs = beam.BeamSearch(decoding_fn,
